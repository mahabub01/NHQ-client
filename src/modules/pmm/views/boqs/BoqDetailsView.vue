<template>
  <div class="container-fluid">
    ...
    <div class="form-bootcamp">
      <div class="row">
        <div class="col-md-4">
          <router-link to="/pmm/boqs"
            >Boq List <i class="fas fa-chevron-right"></i
          ></router-link>
          <router-link to="#">Boq Details</router-link>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 offset-md-3">
            <h4 class="form-page-title details-header-title">Boq Details</h4>
            <div class="row">
              <div class="col-md-6">
                <!--start-->
                <div>
                  <h5 class="data-label">Boq ID</h5>
                ...
                <!--start-->
                <div>
                  <h5 class="data-label">Boq Title</h5>
                  <p class="data-text" v-if="getInformation != null">
                ...
                <!--start-->
                <div>
                  <h5 class="data-label">Boq Category</h5>
                  <p class="data-text" v-if="getInformation != null">
