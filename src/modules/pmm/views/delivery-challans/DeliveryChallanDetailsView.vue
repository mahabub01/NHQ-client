<template>
  <div class="container-fluid">
    ...
    <div class="form-bootcamp">
      <div class="row">
        <div class="col-md-4">
          <router-link to="/pmm/delivery-challans"
            >Delivery Challan List <i class="fas fa-chevron-right"></i
          ></router-link>
              ...
              <div class="col-md-6">
                ...
                <div>
                  ...
                  <p class="data-text" v-if="getInformation != null">
                    {{ getInformation.delivery_challan_title }}
                  </p>
                </div>
                <!--end-->
...
async function loadSingleData() {
  ...
  await Axios.get(
    "/projects/delivery-challan-details/" + route.params.slug
  ).then((response) => {
