<template>
  <div class="container-fluid">
    ...
    <div class="form-bootcamp">
      <div class="row">
        <div class="col-md-4">
          <router-link to="/pmm/delivery-timeline"
            >Delivery Timeline List <i class="fas fa-chevron-right"></i
          ></router-link>
              ...
              <div class="col-md-6">
                ...
                <div>
                  ...
                  <p class="data-text" v-if="getInformation != null">
                    {{ getInformation.delivery_timeline_title }}
                  </p>
                </div>
                <!--end-->
...
async function loadSingleData() {
  ...
  await Axios.get(
    "/projects/delivery-timeline-details/" + route.params.slug
  ).then((response) => {
