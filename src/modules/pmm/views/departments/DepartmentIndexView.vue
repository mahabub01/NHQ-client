                ...
                <div class="col-md-5">
                  <div class="page-bootcamp-right">
                    <div>
                      ...
                      <button
                        v-if="getPermission(`create_department`)"
                        type="button"
                        class="link_btn"
                        style="margin-right: 7px"
                        @click="
                      ...
                      <div class="btn-group">
                        <button
                          v-if="getPermission(`bulk_delete_department`)"
                          type="button"
    ...
    <div>
      <create-modal>
        <template v-slot:header
          ><i class="fas fa-plus-square"></i> Create Department
        </template>
    ...
    <div>
      <edit-modal>
        <template v-slot:editheader>
          <i class="fas fa-plus-square"></i> Edit Department
        </template>
...
watch([titleSearch], async () => {
  ...
  await Axios.get(
    "/employee/departments?showEntries=" +
